...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar">
        <?php echo e(!empty($recovery) ?__('Recovery Events') : __("Manage Events")); ?>

        <?php if(Auth::user()->hasPermissionTo('event_create') && empty($recovery)): ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubgmart.com/public_html/etrip/themes/Mytravel/Event/Views/frontend/vendorEvent/index.blade.php ENDPATH**/ ?>