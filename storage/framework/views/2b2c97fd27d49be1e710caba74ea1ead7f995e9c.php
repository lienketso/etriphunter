...
<head>
    ...
    <link href="<?php echo e(asset('dist/admin/css/custom.css')); ?>" rel="stylesheet">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Liên Kết Số')); ?> <a href="<?php echo e(__('https://www.lienketso.vn')); ?>" target="_blank"><?php echo e(__('Liên Kết Số Jsc')); ?></a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="<?php echo e(__('https://lienketso.vn/#about')); ?>" target="_blank"><?php echo e(__('About Us')); ?></a>
                            <a href="<?php echo e(__('https://lienketso.vn/#contact')); ?>" target="_blank"><?php echo e(__('Contact Us')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\etrip\modules/Layout/admin/app.blade.php ENDPATH**/ ?>