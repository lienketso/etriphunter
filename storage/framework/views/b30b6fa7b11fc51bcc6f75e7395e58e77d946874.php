    ...
    <form action="<?php echo e(route('user.admin.store',['id'=>$row->id ?? -1])); ?>" method="post" class="needs-validation" novalidate>
        ...
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? 'Edit: '.$row->first_name.' '.$row->last_name : 'Add new user'); ?></h1>
                </div>
            </div>
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-controls">
                                        <label><?php echo e(__("Privilege")); ?></label>
                                        <select name="privilege_id" class="form-control">
                                            ...
                                            <option value="<?php echo e($privilege->id); ?>"<?php if($privilege->id==$row->privilege_id): ?>
                                            selected
                                            <?php endif; ?>><?php echo e($privilege->privilege_name); ?></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(__('Privilege available till')); ?></label>
                                        <input type="text" value="<?php echo e(old('birthday',$row->privilege_available ? date("Y/m/d",strtotime($row->privilege_available)) :'')); ?>" placeholder="<?php echo e(__('Privilege available till')); ?>" name="privilege_available" class="form-control has-datepicker input-group date">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <?php
                                            if(!is_null($row->business_areas) || $row->business_areas!=''){
                                                $business = json_decode($row->business_areas);
                                            }else{
                                                $business = array();
                                            }
                                        ?>
                                        <p>Danh sách dịch vụ</p>
                                        <input type="checkbox" name="business_areas[]" value="tour" <?php echo e((in_array('tour',$business) ? 'checked' : '')); ?> ><span>Tour</span>
                                        <input type="checkbox" name="business_areas[]" value="hotel" <?php echo e((in_array('hotel',$business) ? 'checked' : '')); ?>><span>Khách sạn</span>
                                        <input type="checkbox" name="business_areas[]" value="flight" <?php echo e((in_array('flight',$business) ? 'checked' : '')); ?>><span>Vé máy bay</span>
                                        <input type="checkbox" name="business_areas[]" value="car" <?php echo e((in_array('car',$business) ? 'checked' : '')); ?>><span>Xe</span>
                                        <input type="checkbox" name="business_areas[]" value="event" <?php echo e((in_array('event',$business) ? 'checked' : '')); ?>><span>Tiện ích</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel">
                        <div class="panel-title"><strong>Đơn vị</strong></div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label>Chọn đơn vị cho người dùng</label>
                                <select class="custom-select dungdt-select2-field" name="company_id">
                                    <option>---Chọn đơn vị---</option>
                                    <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e(($row->company_id==$d->id) ? 'selected' : ''); ?> value="<?php echo e($d->id); ?>"><?php echo e($d->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\etrip\modules/User/Views/admin/detail.blade.php ENDPATH**/ ?>