        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(route('tour.admin.attribute.editAttrBulk')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(route('tour.admin.attribute.index')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                                ...
                                <?php if(count($rows) > 0): ?>
                                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="title">
                                                <a href="<?php echo e(route('tour.admin.attribute.edit', ['id' => $row->id])); ?>"><?php echo e($row->name); ?></a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('tour.admin.attribute.edit', ['id' => $row->id])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo e(__('Edit')); ?>

                                                </a>
                                                <a href="<?php echo e(route('tour.admin.attribute.term.index', ['attr_id' => $row->id])); ?>" class="btn btn-sm btn-success"><i class="fa fa"></i> <?php echo e(__("Manage Terms")); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubgmart.com/public_html/etrip/modules/Tour/Views/admin/attribute/index.blade.php ENDPATH**/ ?>