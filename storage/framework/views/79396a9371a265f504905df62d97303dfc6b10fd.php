                            ...
                            <?php if(count($rows) > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm btn-primary" href="<?php echo e(route('template.admin.exportTemplate',[$row->id])); ?>"> <i class="fa fa-download" aria-hidden="true"></i> <?php echo e(__('Export')); ?></a></td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubgmart.com/public_html/etrip/modules/Template/Views/admin/index.blade.php ENDPATH**/ ?>