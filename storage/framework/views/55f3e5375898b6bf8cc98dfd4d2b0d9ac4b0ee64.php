            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="number" max="100" min="0"
                           value="<?php echo e(setting_item_with_lang('user_persional_percent',request()->query('lang')) ?? ''); ?>"
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label>% Chiết khấu</label>
                    <input type="number" max="100" min="0"
                           value="<?php echo e(setting_item_with_lang('user_company_percent',request()->query('lang')) ?? ''); ?>"
...
<?php /**PATH C:\laragon\www\etrip\modules/User/Views/admin/settings/user.blade.php ENDPATH**/ ?>