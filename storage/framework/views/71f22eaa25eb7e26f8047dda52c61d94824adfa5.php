                        ...
                        <?php if($rows->total() > 0): ?>
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="title">
                                        <a href="<?php echo e(route('user.admin.detail',['id'=>@$row->user->id])); ?>"><?php echo e(@$row->user->first_name.' '.$row->user->last_name); ?></a>
                                    </td>
                                    <td><?php echo e(@$row->user->getDisplayName()); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\etrip\modules/User/Views/admin/upgrade-user.blade.php ENDPATH**/ ?>