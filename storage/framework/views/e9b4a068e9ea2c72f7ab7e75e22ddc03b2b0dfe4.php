                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($row->status); ?>">
                                        ...
                                        <td><a href="<?php echo e(route('tour.admin.schedule.index',$row->id)); ?>" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i> Xem lịch trình
                                            </a></td>
                                        <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\etrip\modules/Tour/Views/admin/index.blade.php ENDPATH**/ ?>