...
<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price" class="form-control" value="<?php echo e($row->price); ?>" placeholder="<?php echo e(__("Event Price")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Sale Price")); ?></label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="<?php echo e($row->sale_price); ?>" placeholder="<?php echo e(__("Event Sale Price")); ?>">
                        <span><i><?php echo e(__("If the regular price is less than the discount , it will show the regular price")); ?></i></span>
                    </div>
                </div>
            </div>
            <div class="form-group-item <?php if( $row->getBookingType()== "time_slot"): ?> d-none <?php endif; ?>" >
                <label class="control-label"><?php echo e(__('Tickets')); ?></label>
                <div class="g-items-header">
                    <div class="row">
                        <div class="col-md-2"><?php echo e(__("Code")); ?></div>
                        <div class="col-md-5"><?php echo e(__("Name")); ?></div>
                        <div class="col-md-4"><?php echo e(__('Price - Number')); ?></div>
                    ...
                    <?php if(!empty($row->ticket_types)): ?>
                        <?php $__currentLoopData = $row->ticket_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item" data-number="<?php echo e($key); ?>">
                                <div class="row">
                                    <div class="col-md-2">
                                        <input type="text" <?php if(!is_default_lang()): ?> disabled <?php endif; ?> name="ticket_types[<?php echo e($key); ?>][code]" class="form-control" value="<?php echo e($item['code']); ?>" placeholder="<?php echo e(__("ticket_vip_1")); ?>">
                                    </div>
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" <?php if(!is_default_lang()): ?> disabled <?php endif; ?> min="0" name="ticket_types[<?php echo e($key); ?>][price]" class="form-control" value="<?php echo e($item['price']); ?>" placeholder="<?php echo e(__("Price Ticket")); ?>" step="any">
                                        <lable><?php echo e(__("Number")); ?></lable>
                                        <input type="number" <?php if(!is_default_lang()): ?> disabled <?php endif; ?> min="0" name="ticket_types[<?php echo e($key); ?>][number]" class="form-control" value="<?php echo e($item['number']); ?>" placeholder="<?php echo e(__("Number Ticket")); ?>">
                                    </div>
                                    <div class="col-md-1">
                                        <?php if(is_default_lang()): ?>
        ...
        <?php if(is_default_lang() and (!empty(setting_item("event_allow_vendor_can_add_service_fee")) or is_admin())): ?>
            <hr>
                            ...
                            <div class="item" data-number="<?php echo e($key); ?>">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <label>
                                            <input type="checkbox" min="0" name="service_fee[<?php echo e($key); ?>][per_ticket]" value="on" <?php if($item['per_ticket'] ?? ''): ?> checked <?php endif; ?> >
...
<?php endif; ?>
<?php /**PATH /home/ubgmart.com/public_html/etrip/modules/Event/Views/admin/event/pricing.blade.php ENDPATH**/ ?>