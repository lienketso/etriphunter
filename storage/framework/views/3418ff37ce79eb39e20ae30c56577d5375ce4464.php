            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <a data-toggle="tab" href="#nav-commission" aria-selected="false"><?php echo e(__("6. Commission")); ?></a>
                        <a data-toggle="tab" href="#nav-ical" aria-selected="false"><?php echo e(__("7. Ical")); ?></a>
                    <?php endif; ?>
                </div>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <div class="tab-pane fade" id="nav-commission">
                            <?php echo $__env->make('Tour::admin/tour/commission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubgmart.com/public_html/etrip/themes/Mytravel/Tour/Views/frontend/manageTour/detail.blade.php ENDPATH**/ ?>