                ...
                <form class="form bravo-form-register-vendor" method="post" action="<?php echo e(route('vendor.register')); ?>">
                    ...
                    <div class="form-group">
                        <div class="list-service-vendor">
                            ...
                            <input type="checkbox" class="form-control" name="business_areas[]" value="service" > <span>Tiện ích khác</span>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/ubgmart.com/public_html/etrip/themes/Base/Vendor/Views/frontend/blocks/form-register/index.blade.php ENDPATH**/ ?>