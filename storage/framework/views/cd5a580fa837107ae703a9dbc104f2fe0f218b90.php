        ...
        <div class="col-md-9">
            ...
            <div class="control-action">
                ...
                <?php if(!empty($recovery)): ?>
                    ...
                    <?php if(Auth::user()->hasPermissionTo('boat_delete')): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <?php if(Auth::user()->hasPermissionTo('boat_update')): ?>
...
<?php /**PATH C:\laragon\www\etrip\themes/Mytravel/Boat/Views/frontend/manageBoat/loop-list.blade.php ENDPATH**/ ?>