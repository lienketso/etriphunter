                        ...
                        <div class="mb-4">
                            <div class="border border-color-7 rounded mb-5">
                                ...
                                <div class="p-3">
                                    <div class="px-2 pt-2">
                                        <?php if($row->map_lat && $row->map_lng): ?>
                                            <a target="_blank" href="https://www.google.com/maps/place/<?php echo e($row->map_lat); ?>,<?php echo e($row->map_lng); ?>/@<?php echo $row->map_lat ?>,<?php echo e($row->map_lng); ?>,<?php echo e(!empty($row->map_zoom) ? $row->map_zoom : 12); ?>z" class="d-block border rounded mb-4">
                                            ...
                                            <div class="flex-horizontal-center mb-4">
                                                <div class="border-primary border rounded-xs px-3 text-lh-1dot7 py-1">
                                                    <span class="font-size-21 font-weight-bold px-1 mb-0 text-lh-inherit text-primary"><?php if($review_score): ?> <?php echo e($review_score['score_total']); ?> <?php endif; ?></span>
                                                </div>

                                                <div class="ml-2 text-lh-1">
                                                    <div class="ml-1">
                                                        <h4 class="text-primary font-size-17 font-weight-bold mb-0"><?php echo e(__('Exceptional')); ?></h4>
                                                        <span class="text-gray-1 font-size-14"><?php echo e(__('Location rating score')); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($translation->address): ?>
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <h6 class="mb-0 font-size-14 text-gray-1">
                                                    <a href="#"><?php echo e(__('Better than 99% of properties in ').$translation->address); ?></a>
                                                </h6>
                                            </div>
                                        <?php endif; ?>
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <h6 class="mb-0 font-size-14 text-gray-1">
                                                <a href="#"><?php echo e(__('Exceptional location - Inside city center')); ?></a>
                                            </h6>
                                        </div>
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="flaticon-home font-size-25 text-primary mr-3 pr-1"></i>
                                            <h6 class="mb-0 font-size-14 text-gray-1">
                                                <a href="#"><?php echo e(__('Popular neighborhood')); ?></a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('themes/mytravel/module/hotel/js/single-hotel.js?_ver='.config('app.version'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubgmart.com/public_html/etrip/themes/Mytravel/Hotel/Views/frontend/detail.blade.php ENDPATH**/ ?>