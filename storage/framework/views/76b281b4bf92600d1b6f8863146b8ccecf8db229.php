                        ...
                        <div class="mb-5 shadow-soft bg-white rounded-sm">
                            <div class="py-6 px-5 border-bottom">
                                <div class="flex-horizontal-center">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="font-size-18 font-weight-bold text-dark mb-0 text-lh-sm header-success">
                                ...
                                <div class="booking-id"><strong><?php echo e(__('Booking ID')); ?> : <span>#ETRIP<?php echo e($booking->id); ?></span></strong></div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\etrip\themes/Mytravel/Booking/Views/frontend/detail.blade.php ENDPATH**/ ?>