        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-5">
                ...
                <p class="sub-heading"><?php echo e($desc); ?></p>
                    ...
                    <div class="form-group">
                        <div class="list-service-vendor">
                            <p>Dịch vụ cung cấp *</p>
                            <input type="checkbox" class="form-control" name="business_areas[]" value="tour" > <span>Tour</span>
                            <input type="checkbox" class="form-control" name="business_areas[]" value="hotel" > <span>Khách sạn</span>
                            <input type="checkbox" class="form-control" name="business_areas[]" value="flight" > <span>Vé máy bay</span>
                            <input type="checkbox" class="form-control" name="business_areas[]" value="car" > <span>Xe</span>
                            <input type="checkbox" class="form-control" name="business_areas[]" value="event" > <span>Tiện ích khác</span>
                        </div>
                        <span class="invalid-feedback error error-business_areas"></span>
                    </div>
                    <div class="form-group">
                        <label>Giấy phép kinh doanh ( Ảnh chụp hoặc file pdf )</label>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\laragon\www\etrip\themes/Base/Vendor/Views/frontend/blocks/form-register/index.blade.php ENDPATH**/ ?>