                ...
                <?php $__currentLoopData = $tour_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-<?php echo e($field['size'] ?? "6"); ?> mb-4 mb-lg-0 text-left">
                        <?php switch($field['field']):
                            ...
                            <?php break; ?>
                            <?php case ('start_location_id'): ?>
                                <?php echo $__env->make('Tour::frontend.layouts.search.fields.from_where', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php break; ?>
                            <?php case ('attr'): ?>
...
<?php /**PATH C:\laragon\www\etrip\themes/Mytravel/Tour/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>