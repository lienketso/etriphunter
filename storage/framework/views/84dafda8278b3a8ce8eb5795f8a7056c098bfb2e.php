<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Spaces")); ?></h1>
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(route('space.admin.bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
            ...
            <div class="col-left dropdown">
                <form method="get" action="<?php echo e(!empty($recovery) ? route('space.admin.recovery') : route('space.admin.index')); ?>" class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($row->status); ?>">
                                    ...
                                    <td class="title">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('space.admin.edit',['id'=>$row->id])); ?>"><?php echo e($row->title); ?></a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('space.admin.edit',['id'=>$row->id])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo e(__('Edit')); ?>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7"><?php echo e(__("No space found")); ?></td>
                            </tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubgmart.com/public_html/etrip/modules/Space/Views/admin/index.blade.php ENDPATH**/ ?>