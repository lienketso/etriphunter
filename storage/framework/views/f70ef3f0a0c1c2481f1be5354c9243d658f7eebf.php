...
<div class="sidebar-user">
    ...
    <div class="sidebar-menu">
        <?php if(Auth::user()->vendor_parent==0): ?>
        <ul class="main-menu">
        ...
        <ul class="main-menu">
            <?php if($dataUser && !empty($dataUser->business_areas)): ?>
                <?php
                    $business = json_decode($dataUser->business_areas);
                ?>
            <?php $__currentLoopData = $business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(route($d.'.vendor.index')); ?>"><i class="fa fa-heart-o"></i> Quản lý <?php echo e(($d=='event') ? 'Tiện ích' : $d); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
            <?php endif; ?>
        </ul>
    ...
    <div class="logout">
        <a href="<?php echo e(route('vendor.list-user')); ?>"><i class="fa fa-user-circle"></i> Quản lý tài khoản</a>
    </div>
    <div class="logout">
        <a href="<?php echo e(route('user.profile.index')); ?>"><i class="fa fa-user"></i> Cập nhật profile</a>
    </div>
    <div class="logout">
...
<?php /**PATH C:\laragon\www\etrip\themes/Base/User/Views/frontend/layouts/sidebar.blade.php ENDPATH**/ ?>