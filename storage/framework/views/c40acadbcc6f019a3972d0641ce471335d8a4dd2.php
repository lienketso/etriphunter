        ...
        <form action="<?php echo e(route("user.verification.store")); ?>" method="post">
            ...
            <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php switch($field['type']):
                    ...
                    <?php break; ?>
                    <?php case ("logo"): ?>
                    <?php echo $__env->make('User::frontend.verification.fields.logo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php break; ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubgmart.com/public_html/etrip/themes/Base/User/Views/frontend/verification/update.blade.php ENDPATH**/ ?>