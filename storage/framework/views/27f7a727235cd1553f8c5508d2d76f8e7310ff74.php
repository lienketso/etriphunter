            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="slots" class="form-control" value="<?php echo e($row->slots); ?>" placeholder="<?php echo e(__("Ex: 3")); ?>">
                        <i>Số chỗ còn nhận</i>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" name="number_of_days" class="form-control" value="<?php echo e($row->number_of_days); ?>"
                                   placeholder="<?php echo e(__("Số ngày tour")); ?>">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
...
<?php /**PATH /home/ubgmart.com/public_html/etrip/modules/Tour/Views/admin/tour/tour-content.blade.php ENDPATH**/ ?>