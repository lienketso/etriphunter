...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('vendor.post-vendor-user',['id'=>$dataUser->id ?? -1])); ?>" method="post" class="input-has-icon">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" value="" placeholder="<?php echo e(__("Password")); ?>" class="form-control">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <p>Quản lý hạng mục</p>
                    <?php if(!empty($dataUser->business_areas)): ?>
                        <?php
                    ...
                    <input type="checkbox" name="business_areas[]" value="service" <?php echo e((in_array('service',$business) ? 'checked' : '')); ?>><span>Tiện ích</span>
                        <?php else: ?>
                        <input type="checkbox" name="business_areas[]" value="tour"><span>Tour</span>
                        <input type="checkbox" name="business_areas[]" value="car"><span>Xe</span>
                        <input type="checkbox" name="business_areas[]" value="flight"><span>Vé máy bay</span>
                        <input type="checkbox" name="business_areas[]" value="hotel"><span>Khách sạn</span>
                        <input type="checkbox" name="business_areas[]" value="service"><span>Tiện ích</span>
                    <?php endif; ?>
                </div>
                <div class="form-group">
                    <label>Quyền</label>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value=""><?php echo e(__('-- Select --')); ?></option>
                        <option value="publish" <?php echo e(($dataUser && $dataUser->status=='publish') ? 'selected' : ''); ?>>Đang sử dụng</option>
                        <option value="blocked" <?php echo e(($dataUser && $dataUser->status=='blocked') ? 'selected' : ''); ?>>Khóa tài khoản</option>
                    </select>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\etrip\modules/Vendor/Views/frontend/users/detail.blade.php ENDPATH**/ ?>