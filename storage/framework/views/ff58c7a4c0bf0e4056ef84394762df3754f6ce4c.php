            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <a data-toggle="tab" href="#nav-deposit" aria-selected="false"><?php echo e(__("6. Deposit")); ?></a>
                    <?php endif; ?>
                </div>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <div class="tab-pane fade" id="nav-deposit">
                            <?php echo $__env->make('Tour::admin/tour/deposit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\etrip\themes/Mytravel/Tour/Views/frontend/manageTour/detail.blade.php ENDPATH**/ ?>