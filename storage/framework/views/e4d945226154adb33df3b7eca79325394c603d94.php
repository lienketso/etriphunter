        ...
        <div class="mb-4">
            <div class="input-group border-bottom border-width-2 border-color-1 py-2">
                ...
                <div class="g-map-place border-0 p-0 form-control  height-40 d-flex" >
                    <input type="text" name="map_place" placeholder="<?php echo e(__("Where are you from?")); ?>"  value="<?php echo e(request()->input('map_place')); ?>" class="font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0">
        ...
        <div class="mb-4">
            <div class="input-group border-bottom border-width-2 border-color-1 py-2">
                ...
                <div class="smart-search border-0 p-0 form-control  height-40">
                    ...
                    <input type="hidden" class="child_id" name="start_location_id" value="<?php echo e(Request::query("start_location_id")); ?>">
                </div>
            </div>
        </div>
    <?php endif; ?>
</div>
<?php /**PATH C:\laragon\www\etrip\themes/Mytravel/Tour/Views/frontend/layouts/search/fields/from_where.blade.php ENDPATH**/ ?>