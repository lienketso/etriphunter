<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Utilities Content")); ?></strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__("Title")); ?></label>
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__("Name of the Utilities")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php /**PATH /home/ubgmart.com/public_html/etrip/modules/Event/Views/admin/event/content.blade.php ENDPATH**/ ?>