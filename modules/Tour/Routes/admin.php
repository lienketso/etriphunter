...
//schedule
Route::get('/schedule/{target_id}','TourController@getSchedule')->name('tour.admin.schedule.index');
Route::get('/create-schedule/{target_id}','TourController@createSchedule')->name('tour.admin.schedule.create');
Route::post('/create-schedule/{target_id}','TourController@postCreateSchedule')->name('tour.admin.schedule.create.post');
Route::get('/edit-schedule/{id}','TourController@getEditSchedule')->name('tour.admin.schedule.edit');
Route::post('/edit-schedule/{id}','TourController@postEditSchedule')->name('tour.admin.schedule.edit.post');
