<?php
    ...
    class TourController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            $location_detail = $this->locationClass::where('id',$request->location_id)->first();
            ...
            $data['attributes'] = $this->attributesClass::where('service', 'tour')->orderBy("position","desc")->with(['terms','translations'])->get();
            if ($layout == "map") {
        ...
        public function detail(Request $request, $slug)
        {
            ...
            if (!empty($location_id)) {
                $tour_related = $this->tourClass::where('location_id', $location_id)->where("status","publish")
                    ->take(4)->whereNotIn('id', [$row->id])->with(['location','translations','hasWishList'])->get();
            }
