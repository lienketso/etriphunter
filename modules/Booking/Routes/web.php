...
//booking request
Route::post('/booking-request','BookingRequestController@createBooking')->name('booking.request');
//checkout vnpay return
Route::get('/vnpay-checkout-return','NormalCheckoutController@VnpayReturn')->name('public.checkout.vnpay-return');
