                ...
                if(!empty($lat = $request->query('map_lat')) and !empty($lgn = $request->query('map_lgn')) and !empty($request->query('map_place')))
{
            ...
            $distance  = setting_item('car_location_radius_value',0);
            if(!empty($distance) and setting_item('car_location_search_style')=='autocompletePlace'){
                $distanceType = setting_item('car_location_radius_type',3959);
                ...
                $model_car->whereRaw($string,[$distanceType,$lat,$lgn,$lat,$distance]);
            }
