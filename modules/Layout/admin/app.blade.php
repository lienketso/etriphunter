...
<head>
    ...
    <link href="{{ asset('dist/admin/css/custom.css') }}" rel="stylesheet">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Liên Kết Số')}} <a href="{{__('https://www.lienketso.vn')}}" target="_blank">{{__('Liên Kết Số Jsc')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://lienketso.vn/#about')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://lienketso.vn/#contact')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
