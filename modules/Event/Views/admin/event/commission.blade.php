            ...
            @else
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label class="control-label">Phí hoa hồng cho trẻ em</label>
                            <input type="number" min="0" name="commission[child]" class="form-control" value="{{$commission->child}}" placeholder="Ex: 100.000">
                            <i>Phí hoa hồng dành cho mỗi trẻ em</i>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label class="control-label">Phí hoa hồng cho trẻ nhỏ</label>
                            <input type="number" min="0" name="commission[young]" class="form-control" value="{{$commission->young}}" placeholder="Ex: 100.000">
                            <i>Phí hoa hồng dành cho mỗi trẻ nhỏ</i>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label class="control-label">Phí hoa hồng cho em bé</label>
                            <input type="number" min="0" name="commission[baby]" class="form-control" value="{{$commission->baby}}" placeholder="Ex: 100.000">
                            <i>Phí hoa hồng dành cho mỗi em bé</i>
                        </div>
                    </div>
                </div>
