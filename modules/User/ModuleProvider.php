...
class ModuleProvider extends ModuleServiceProvider
{
    ...
    public static function getAdminMenu()
    {
        ...
        $noti = $noti_verify;
        $noti_agency = User::where('agency_type','!=',null)->where('file_agency','!=',null)->where('is_agency',0)->count();
        ...
        $options = [
            ...
            'children'   => [
                ...
                'updateAgency'=>[
                    'url' => route('user.admin.getUserAgency'),
                    'title' => __('Update agency :count',['count'=>$noti_agency ? sprintf('<span class="badge badge-warning">%d</span>',$noti_agency) : '']),
                    'permission'=>'user_view'
                ],
                'importUser'=>[
                    'url' => route('user.admin.import.get'),
    ...
    public static function getTemplateBlocks(){
        return [
            'agency_register_form'=>"\\Modules\\User\\Blocks\\AgencyRegister",
        ];
    }
