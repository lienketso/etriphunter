...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::match(['get'],'/upgrade-privilege','UserController@upgradePrivilege')->name("user.upgrade_privilege");
    Route::get('/purchase-privilege','BookingController@purchasePrivilege')->name("user.purchase_privilege");

    //become agency
    Route::get('/become-agency','UserController@becomeAgency')->name('user.become_agency');
    Route::post('/become-agency','UserController@postBecomeAgency')->name('user.become_agency.post');
...
Route::post('agency-register','UserController@registerAgency')->name('agency.register');
