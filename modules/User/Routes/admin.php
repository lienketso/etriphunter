...
Route::get('userUpgradeAgency','UserController@getUserAgency')->name('user.admin.getUserAgency');
Route::get('get-approved-agency/{id}','UserController@getUserAgencyUpgrade')->name('user.admin.getUserAgency.upgrade');

Route::get('/import-member','UserController@getUserImport')->name('user.admin.import.get');
Route::post('/import-member', 'UserController@userImportRequest')->name('user.admin.import');
