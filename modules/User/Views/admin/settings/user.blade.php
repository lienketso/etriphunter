...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__("Two Factor Authentication")}}</h3>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-title"><strong>{{__("Two Factor Authentication")}}</strong></div>
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                        ...
                        <p>{{__('When two factor authentication feature is enabled, the user is required to input a six digit numeric token during the authentication process. This token is generated using a time-based one-time password (TOTP) that can be retrieved from any TOTP compatible mobile authentication application such as Google Authenticator.')}}</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">Chiết khấu cho đại lý cá nhân ( % )</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="number" max="100" min="0"
                           value="{{setting_item_with_lang('user_persional_percent',request()->query('lang')) ?? '' }}"
                           name="user_persional_percent" class="form-control">
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">Chiết khấu cho đại lý doanh ngiệp ( % )</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label>% Chiết khấu</label>
                    <input type="number" max="100" min="0"
                           value="{{setting_item_with_lang('user_company_percent',request()->query('lang')) ?? '' }}"
                           name="user_company_percent" class="form-control">
                </div>
            </div>
        </div>
    </div>
