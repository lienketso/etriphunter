    ...
    <form action="{{route('user.admin.store',['id'=>$row->id ?? -1])}}" method="post" class="needs-validation" novalidate>
        ...
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? 'Edit: '.$row->first_name.' '.$row->last_name : 'Add new user'}}</h1>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-controls">
                                        ...
                                        <select name="privilege_id" class="form-control">
                                            ...
                                            <option value="{{$privilege->id}}"@if ($privilege->id==$row->privilege_id)
                                            selected
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('birthday',$row->privilege_available ? date("Y/m/d",strtotime($row->privilege_available)) :'') }}" placeholder="{{ __('Privilege available till')}}" name="privilege_available" class="form-control has-datepicker input-group date">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="business_areas[]" value="event" {{(in_array('event',$business) ? 'checked' : '')}}><span>Tiện ích</span>
                                    </div>
                                </div>
                            </div>
