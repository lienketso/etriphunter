...
<p>This document was last updated on October 6, 2020</p>';
        ...
        DB::table('core_settings')->insert([
            ...
            [
                'name'=>'tour_request_success',
                'val'=>'<p>cảm ơn quý khách đã đặt dịch vụ tại Etrip Hunter, chúng tôi đã nhận được yêu cầu của quý khách, chuyên viên sale tại Etrip Hunter sẽ liên hệ đến quý khách sớm nhất, xin chân thành cảm ơn</p>',
                'group'=>'booking'
            ]
        ]);
    }
