<?php
namespace Themes\Mytravel\Event\Blocks;

use Modules\Template\Blocks\BaseBlock;
use Modules\Event\Models\Event;
use Modules\Location\Models\Location;

class ListEvent extends \Modules\Event\Blocks\ListEvent
{
        ...
        $this->setOptions([
            'settings' => [
                ...
                [
                    'id'           => 'custom_ids',
                    'type'         => 'select2',
                    'label'        => __('List Utilities by IDs'),
                    'select2'      => [
                        'ajax'     => [
            ...
            'category'=>__("Utilities Blocks")
        ]);
    }

    public function getName()
    {
        return __('Utilities: List Items');
    }
